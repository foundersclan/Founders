...
export const Events = () => {
  ...
  const events = [
    {
      url: "/assets/seminar.jpg",
      name: " SF Tech Week",
      location: "San Francisco",
      date: "Oct 6 – Oct 12",
      features: "Featured in Tech",
      description: "Explore events and innovations at SF Tech Week — where technology, creativity, and networking come together to shape the future."
    },
    {
      url: "/assets/seminar.jpg",
      name: " SF Tech Week",
  ...
  return (
    <section className="min-h-screen bg-zinc-950 text-white mb-10 mt-5">
      <div className="w-full flex flex-col gap-10 justify-center mt-5  items-center">
      {
        events.map((event)=>{
          return (
              <div className={`  w-11/12 relative rounded-3xl max-h-1/2 flex justify-between bg-zinc-900  `}>
                <div className="w-1/2 ">
                <img src={`${event.url}`} className="w-full h-full object-contain " alt="" />
                </div>
                {/* <div className="absolute w-full inset-0 bg-black/" /> */}
                <div className="relative z-10 p-10 max-w-3xl text-white">
                  <motion.div
                  ...
                  >
                    ...
                    <h1 className="text-4xl md:text-3xl font-bold text-yellow-400">
                     {
                      event.name
                     }
                    </h1>
